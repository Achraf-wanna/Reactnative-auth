...
import AddAssistence from './app/auth/sign-up/sign-up'
import logAssistence from './app/auth/sign-in/SignIn'
...
export default function App() {
  return (
    <NativeRouter>
      <Switch>
      <Route exact path="/" component={AddAssistence} />
        <Route exact path="/Splash" component={Splash} />
        <Route exact path="/singup" component={logAssistence} />
